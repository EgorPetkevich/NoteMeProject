...
final class TimerNotificationVC: UIViewController {
    ...
    LineTextField()
        ...
        .setInputView(
            DatePickerView()
                .setDatePickerMode(.countDownTimer)
    ...
    private func bindError() {
        ...
        viewModel.catchTimerError = { [weak self] errorText in
    ...
    private func bindEditNotification() {
        dateTextField.text = viewModel.editTimer
...
extension TimerNotificationVC: UIGestureRecognizerDelegate {
